/* Root certificates (generated with BearSSL's "brssl ta" from the host CA bundle) */
#include <bearssl.h>
...
static const unsigned char TA23_EC_Q[] = {
...
static const br_x509_trust_anchor TAs[121] = {
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA23_EC_Q, sizeof TA23_EC_Q,
			} }
		}
	},
	{
...
const br_x509_trust_anchor *tls_trust_anchors = TAs;
const size_t tls_trust_anchors_num = TAs_NUM;
