#pragma once
/* Key codes: position based (PC scancode set 1; 0x80 | code for E0-prefixed keys) */
...
#define KEY_LSUPER     0xDB
#define KEY_RSUPER     0xDC
